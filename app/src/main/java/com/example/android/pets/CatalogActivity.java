...
protected  void onStart()
{
    ...
    private void displayDatabaseInfo() {
        ...
        String[] projection = {PetContract.PetsEntry._ID, PetContract.PetsEntry.COLUMN_PET_NAME, PetContract.PetsEntry.COLUMN_PET_BREED, PetContract.PetsEntry.COLUMN_PET_GENDER, PetContract.PetsEntry.COLUMN_PET_WEIGHT};
        ...
        try {
            ...
            displayView.setText("There are " + cursor.getCount()+" pets in shelter. \n");
    ...
    public void insertData()
    {
        ...
        values.put(PetContract.PetsEntry.COLUMN_PET_NAME,"Google");
        values.put(PetContract.PetsEntry.COLUMN_PET_BREED,"German Shephard");
        ...
        Uri uri = getContentResolver().insert(PetContract.PetsEntry.CONTENT_URI,values);
