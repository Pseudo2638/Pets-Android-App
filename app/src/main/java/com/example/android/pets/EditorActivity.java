...
public class EditorActivity extends AppCompatActivity {
    ...
    private  void insertPet()
    {
        ...
        values.put(PetContract.PetsEntry.COLUMN_PET_NAME,name);
        values.put(PetContract.PetsEntry.COLUMN_PET_BREED,breed);
        values.put(PetContract.PetsEntry.COLUMN_PET_GENDER, mGender);
        values.put(PetContract.PetsEntry.COLUMN_PET_WEIGHT,weightCount);
